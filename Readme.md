...
# Configuration Script – GPS collar for livestock - Rev. A

This **Configuration** script is designed for the **GPS collar for livestock** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – GPS collar for livestock Rev. A

Este script de **Configuration** está diseñado para el modelo **GPS collar for livestock** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
